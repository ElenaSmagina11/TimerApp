...
public class TimerApp extends JFrame {
	...
	// public void setTimefields() //po umolchaniu videlit li otdelnij metod dla
	// setup
	/**
	 * <p>
	...
	// / private FileInputStream jlPlayer;
...
//		numberOfCycles
//				.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);// vremenno!!
		numberOfCycles.setFont(font2);
		content.add(numberOfCycles);

		// content Arbeitsperiod
		// kolvo ziklov
		/**
		...
		// buttons
		// / final JToggleButton startButton = new JToggleButton("START",
		// false);
		// / final JToggleButton startButton = new JToggleButton(new
		// ImageIcon(ImageIO.read(getClass().getResource("resources/pausedisabledP.png"))),
		// false);
		// / Knopki opisat!
		/**
		...
		// startStopButton.setSize(10, 10);
		// startStopButton.setLocation(220, 10);
		content.add(startButton);

		// / final JToggleButton resetButton = new JToggleButton("RESET",
		// false);
		/**
		...
		timeNowLabel.setFont(font2); // NOI18N
		...
		// messagesField.setBackground(colorTextField);
		...
		pauseButton.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				// String text = (resetButton.isSelected()) ? "RESET" : "STOP";
		...
		//
		// public void itemStateChanged(ItemEvent e) {
		// // String text = (startStopButton.isSelected()) ? "START" : "STOP";
		// // String text2 = (resetButton.isSelected()) ? "RESET" : "STOP";
		// // startStopButton.setText(text);
		// // resetButton.setText(text2);
		...
		// /// checkInput();
		// // startTimer()
		// for(int i = 0; i < 3; i++) { //4 zikla po 10+5 sek. eto toge cse mona
		// v otdelnij method videlit
		// /// count(Integer.valueOf(jobTime.getText()));
		// // run(Integer.valueOf(jobTime.getText()));
		// System.out.println("pausa nacalas!");
		// // JOptionPane.showMessageDialog(null, "REMINDER: Stand up!" +
		// // System.getProperty("line.separator") +
		// // " Walk around a little, maybe get some fresh air.");
		// /// count(Integer.valueOf(lunchTime.getText()));
		// System.out.println("pausa koncilas!");
		// //
		// // JOptionPane.showMessageDialog(null, "REMINDER:go arbeiten!!" +
		// // System.getProperty("line.separator") +
		// // " sofort!");
		// // arbeitsTime();
		// // pauseTime();
		// }
		// System.out.println("na obed!");
		// count(Integer.valueOf(jobTime.getText()));
		// System.out.println("za rabotu posle obeda!");
		// startStopButton.setEnabled(true);//knopku otgatj
		// }
		//
		// }
		// );
		// //END START________________________________________________-
		/**
		...
		startButton.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				// resetButton.setText("Pause");
				// startStopButton.setText("Pause");
				// startStopButton.setEnabled(true);
				System.out.println("Poehali!");
				Toolkit.getDefaultToolkit().beep();

				// proverka polej na ne 0
				if (checkInput()) {
					// / сycleMax = Integer.valueOf(numberOfCycles.getText());
					// rto ne robit!!! zikl ne koncaetsa
			...
			public void run() {
				if (!isPaused) {
					...
					{ // timertask of full jobcycle is completed
						...
						play(lunchMp3);
						// Toolkit.getDefaultToolkit().beep(); ohme musik
	...
	* Method runs timertask during the duration of the coffeepause of the
	...
	//
	// public void periodTimer(int period, String musik, int cycle ) // runs for
	// long break time
	// {
	// timer = new Timer();
	// timer.schedule(new TimerTask() {
